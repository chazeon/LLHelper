...
function makeSaveData() {
    return new LLSaveData({'version': 104, 'team': comp_team.getMembers(), 'gemstock': comp_gemstock.saveData(), 'submember': []});
}
...
function renderPage(loadDeferred) {
    ...
    function init(cardData, songData, metaData, accessoryData) {
        ...
        persister.register('llnewunitsis_gemstock', comp_gemstock);
